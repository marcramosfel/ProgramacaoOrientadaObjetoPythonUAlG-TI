...
class Jogo(ABC) :
    ...
    def jogar(self) :
        ...
        while True:
            ...
            if self.terminou(): #se for retornado true
                self.mostra_tabuleiro()
...
class QuatroLinha(Jogo) :
        ...
        while True :
            ...
            for i in range(7, -1, -1):
                if self.tabuleiro[(i, self.coluna)] == ' ':  # verifica se a posicao nao esta preenchida , i.e., e valida
                    self.tabuleiro[(i, self.coluna)] = ['X', 'O'][self.jogador] #vai colocar o valor de x ou o, conforme o valor de jogador
                    #print(self.tabuleiro[(i, self.coluna)])
    ...
    def terminou(self) :
        ...
        for c in range(8):
            for l in range(5):
                for k in range(0, 4):
                    if not self.tabuleiro[(l + k, c + k)] == ['X', 'O'][self.jogador]:
                        break
                else:
                    return True
